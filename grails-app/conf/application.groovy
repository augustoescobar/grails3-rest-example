...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'grails3.rest.exampe.auth.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'grails3.rest.exampe.auth.UserRole'
grails.plugin.springsecurity.authority.className = 'grails3.rest.exampe.auth.Role'
